...
SLASH_COMMANDS = [
    ...
    ("/transcript [approvals [latest|SESSION] [--denied]]", "顯示 transcript 路徑；approvals 會列出本輪或指定 session 的 YELLOW approval receipts"),
    ...
    ("/infra [all|quick|project|resource|home|vps|resource-bundle]", "讀取專案/資源地圖；home/vps 會抽取家庭 AI 設施與 VPS 章節，混合 alias 會載入 resource+home+vps（read-only）"),
...
COMMAND_EXAMPLES = {
    ...
    "/workflows": ["/workflows"],
    "/init": ["/init"],
    "/task": ["/task status", "/task add 補 README 文件", "/task update 1 done"],
    "/doctor": ["/doctor"],
    "/config": ["/config", "/config set mode agent"],
    "/tools": ["/tools"],
    "/context": ["/context"],
    "/compact": ["/compact"],
    "/history": ["/history"],
    "/jobs": ["/jobs"],
    "/cancel": ["/cancel 3", "/cancel all"],
    "/sessions": ["/sessions"],
    "/handoff": ["/handoff 完成 CLI help 覆蓋率補強"],
    "/resume": ["/resume latest"],
    "/files": ["/files", "/files src/agentx"],
    "/read": ["/read README.md"],
    "/attach": ["/attach README.md docs/product-tour.md"],
    "/find": ["/find workflow"],
    "/where": ["/where slash command dispatch"],
    ...
    "/unstage": ["/unstage README.md"],
    "/push": ["/push"],
    "/apply": ["/apply fix.patch"],
    "/approval": ["/approval", "/approval strict"],
    "/memory": ["/memory agentX handoff"],
    ...
    "/plan": ["/plan"],
    "/execute": ["/execute"],
    "/mode": ["/mode chat", "/mode agent", "/mode ask"],
    "/models": ["/models"],
    "/model": ["/model", "/model gemma4:31b"],
    "/persona": ["/persona", "/persona gemma4"],
    "/remember": ["/remember agentX 新增 command help metadata 覆蓋率"],
    "/status": ["/status"],
    "/clear": ["/clear"],
    "/exit": ["/exit"],
    "/quit": ["/quit"],
...
COMMAND_RELATED = {
    ...
    "/guide": ["/help", "/workflows", "/tools"],
    "/workflow": ["/workflows", "/guide", "/help"],
    "/workflows": ["/workflow", "/guide", "/help"],
    "/init": ["/doctor", "/memory", "/remember"],
    "/task": ["/plan-task", "/intent", "/status"],
    "/doctor": ["/status", "/config", "/tools"],
    "/config": ["/doctor", "/status", "/model"],
    "/tools": ["/approval", "/run", "/help"],
    "/context": ["/compact", "/status", "/clear"],
    "/compact": ["/context", "/status", "/clear"],
    "/history": ["/sessions", "/transcript", "/handoff"],
    "/jobs": ["/cancel", "/status"],
    "/cancel": ["/jobs", "/status"],
    "/sessions": ["/resume", "/transcript", "/handoff"],
    "/handoff": ["/sessions", "/resume", "/memory"],
    "/resume": ["/sessions", "/transcript", "/handoff"],
    "/files": ["/read", "/find", "/where"],
    "/read": ["/files", "/find", "/attach"],
    "/attach": ["/read", "/files", "/context"],
    "/find": ["/read", "/search", "/where"],
    "/where": ["/find", "/read", "/infra"],
    "/infra": ["/intent", "/where", "/read"],
    "/intent": ["/infra", "/plan-task", "/task"],
    "/plan-task": ["/task", "/intent", "/guide"],
    "/grep": ["/search", "/read", "/where"],
    "/search": ["/grep", "/read", "/find"],
    "/fetch": ["/read", "/attach", "/intent"],
    "/transcript": ["/sessions", "/resume", "/handoff"],
    "/git": ["/diff", "/review", "/commit"],
    "/diff": ["/git", "/review", "/commit"],
    "/stage": ["/diff", "/git", "/commit"],
    "/unstage": ["/stage", "/diff", "/git"],
    "/push": ["/git", "/commit", "/review"],
    "/apply": ["/diff", "/review", "/test"],
    "/approval": ["/tools", "/run", "/docker"],
    "/memory": ["/remember", "/handoff", "/resume"],
    "/run": ["/tools", "/approval", "/test"],
    "/docker": ["/tools", "/approval", "/run"],
    "/test": ["/review", "/commit"],
    "/review": ["/diff", "/test", "/commit"],
    "/commit": ["/review", "/test", "/push"],
    "/plan": ["/execute", "/mode", "/plan-task"],
    "/execute": ["/plan", "/mode", "/task"],
    "/mode": ["/plan", "/execute", "/status"],
    "/models": ["/model", "/status", "/doctor"],
    "/model": ["/models", "/status", "/config"],
    "/persona": ["/mode", "/status", "/model"],
    "/remember": ["/memory", "/handoff", "/resume"],
    "/status": ["/context", "/model", "/approval"],
    "/clear": ["/context", "/resume", "/status"],
    "/exit": ["/quit", "/handoff", "/sessions"],
    "/quit": ["/exit", "/handoff", "/sessions"],
}
