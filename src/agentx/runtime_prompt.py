...
- The shell itself supports slash commands such as /files, /read, /find, /where, /infra, /intent, /plan-task, /grep, /search, /fetch, /git, /diff, /push, /docker, /test, /memory, /remember, /mode ask, /mode agent, /workflows, and /model.
...
- plan_task: {"text":"user request"} — produce a read-only checklist and suggested /task add commands for a request; does not mutate tasks
